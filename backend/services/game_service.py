...
class GameService:
    ...
    def play_card(self, game_id: str, player_index: int, hand_index: int) -> Optional[Dict[str, Any]]:
        """
        ...
        logger.info(f"Game {game_id}: Player {player_index} playing card at index {hand_index}")
